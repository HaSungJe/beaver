...
## How to run
Execute `${CLAUDE_PLUGIN_ROOT}/skills/plan/SKILL.md` **with the overrides below**. Every section not overridden applies verbatim — mode detection (§1), new mode (§3), change mode (§4), convention-area reinforcement (§4.5), reporting (§5).
